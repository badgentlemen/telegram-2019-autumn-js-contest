...
Config.App = {
	id: 1159173,
    hash: 'b002b51c5445ff784ac36665b0ba3612',
    version: '1.0.0'
};
	...
	constructors: [
		...
		},
		{
			...
			params: [
				...
				{ name: 'photo_small', type: 'FileLocation' },
		...
		},
		{
			...
			params: [
				...
				{ name: 'admins_enabled', type: 'flags.3?true' },
				{ name: 'admin', type: 'flags.4?true' },
		...
		},
		{
			...
			params: [
				{ name: 'type', type: 'string' },
				{ name: 'location', type: 'FileLocation' },
				{ name: 'w', type: 'int' },
				{ name: 'h', type: 'int' },
				{ name: 'size', type: 'int' }
			],
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'show_previews', type: 'flags.0?true' },
				{ name: 'silent', type: 'flags.1?true' },
				{ name: 'mute_until', type: 'int' },
		...
		},
		{
			...
			params: [
				{ name: 'my_link', type: 'ContactLink' },
				{ name: 'foreign_link', type: 'ContactLink' },
				{ name: 'user', type: 'User' }
			],
			type: 'contacts.Link'
		},
		...
		},
		{
			...
			params: [
				{ name: 'blocked', type: 'Vector<ContactBlocked>' },
				{ name: 'users', type: 'Vector<User>' }
			],
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'new_salt', type: 'flags.0?bytes' },
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'installed', type: 'flags.0?true' },
		...
		},
		{
			...
			params: [
				...
				{ name: 'democracy', type: 'flags.10?true' },
				...
				{ name: 'admin_rights', type: 'flags.14?ChannelAdminRights' },
		...
		},
		{
			...
			params: [
				...
				{ name: 'results', type: 'Vector<FoundGif>' }
			],
		...
		},
		{
			...
			params: [
				...
				{ name: 'content_url', type: 'flags.5?string' },
				{ name: 'content_type', type: 'flags.5?string' },
				{ name: 'w', type: 'flags.6?int' },
				{ name: 'h', type: 'flags.6?int' },
				{ name: 'duration', type: 'flags.7?int' },
		...
		},
		{
			...
			params: [
				...
				{ name: 'items', type: 'Vector<RichText>' }
			],
			type: 'PageBlock'
		},
		{
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'order', type: 'flags.0?Vector<Peer>' }
			],
			type: 'Update'
		},
		{
		...
		},
		{
			...
			params: [
				...
				{ name: 'cdn_file_hashes', type: 'Vector<CdnFileHash>' }
			],
			type: 'upload.File'
		},
		{
		...
		},
		{
			...
			params: [
				...
				{ name: 'manage_call', type: 'flags.10?true' }
			],
		...
		},
		{
			...
			params: [
				...
				{ name: 'user_id', type: 'int' },
				{ name: 'kicked_by', type: 'int' },
				{ name: 'date', type: 'int' },
				{ name: 'banned_rights', type: 'ChannelBannedRights' }
			],
			type: 'ChannelParticipant'
		},
		{
		...
		},
		{
			...
			params: [
				{ name: 'prev_photo', type: 'ChatPhoto' },
		...
		},
		{
			...
			params: [
				...
				{ name: 'google_transaction_id', type: 'string' }
			],
			type: 'InputPaymentCredentials'
		},
		{
	...
	methods: [
		...
		},
		{
			...
			params: [
				...
				{ name: 'grouped', type: 'flags.9?true' },
		...
		},
		{
			...
			params: [
				{ name: 'current_password_hash', type: 'bytes' },
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'no_webpage', type: 'flags.1?true' },
				{ name: 'stop_geo_live', type: 'flags.12?true' },
				{ name: 'peer', type: 'InputPeer' },
				{ name: 'id', type: 'int' },
				{ name: 'message', type: 'flags.11?string' },
				{ name: 'reply_markup', type: 'flags.2?ReplyMarkup' },
				{ name: 'entities', type: 'flags.3?Vector<MessageEntity>' },
				{ name: 'geo_point', type: 'flags.13?InputGeoPoint' }
			],
			type: 'Updates'
		},
		{
		...
		},
		{
			...
			params: [
				{ name: 'flags', type: '#' },
				{ name: 'force', type: 'flags.0?true' },
				{ name: 'order', type: 'Vector<InputPeer>' }
			],
			type: 'Bool'
		},
		{
